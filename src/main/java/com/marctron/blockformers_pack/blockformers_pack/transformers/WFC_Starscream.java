...
public class WFC_Starscream extends Transformer {


    public WFC_Starscream() {
        super(new Properties()
                .setName("WFC Starscream")
                .setCharacterIcon(new ResourceLocation(Blockformers_Pack.MOD_ID, "textures/icons/wfc_starscream.png"))
