...
public class WFC_Sideswipe extends Transformer {


    public WFC_Sideswipe() {
        super(new Properties()
                .setName("WFC Sideswipe")
                .setCharacterIcon(new ResourceLocation(Blockformers_Pack.MOD_ID, "textures/icons/wfc_sideswipe.png"))
