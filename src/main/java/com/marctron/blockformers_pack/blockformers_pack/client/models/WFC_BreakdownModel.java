...
public class WFC_BreakdownModel extends AnimatedGeoModel {

    @Override
    public ResourceLocation getModelLocation(Object transformer) {
        return new ResourceLocation(Blockformers_Pack.MOD_ID, "geo/transformers/wfc_breakdown.geo.json");
    }

    @Override
    public ResourceLocation getTextureLocation(Object transformer) {
        return new ResourceLocation(Blockformers_Pack.MOD_ID, "textures/transformers/wfc_breakdown.png");
    }

    @Override
    public ResourceLocation getAnimationFileLocation(Object transformer) {
        return new ResourceLocation(Blockformers_Pack.MOD_ID, "animations/transformers/wfc_breakdown.animation.json");
    }
