...
public class G1ThundercrackerModel extends AnimatedGeoModel {

    @Override
    public ResourceLocation getModelLocation(Object transformer) {
        return new ResourceLocation(Blockformers_Pack.MOD_ID, "geo/transformers/g1_seeker.geo.json");
    }

    @Override
    public ResourceLocation getTextureLocation(Object transformer) {
        return new ResourceLocation(Blockformers_Pack.MOD_ID, "textures/transformers/g1_thundercracker.png");
    }

    @Override
    public ResourceLocation getAnimationFileLocation(Object transformer) {
        return new ResourceLocation(Blockformers_Pack.MOD_ID, "animations/transformers/g1_seeker.animation.json");
    }
