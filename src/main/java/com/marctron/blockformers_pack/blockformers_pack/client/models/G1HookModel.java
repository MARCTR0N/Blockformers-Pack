...
public class G1HookModel extends AnimatedGeoModel {

    @Override
    public ResourceLocation getModelLocation(Object transformer) {
        return new ResourceLocation(Blockformers_Pack.MOD_ID, "geo/transformers/g1_hook.geo.json");
    }

    @Override
    public ResourceLocation getTextureLocation(Object transformer) {
        return new ResourceLocation(Blockformers_Pack.MOD_ID, "textures/transformers/g1_hook.png");
    }

    @Override
    public ResourceLocation getAnimationFileLocation(Object transformer) {
        return new ResourceLocation(Blockformers_Pack.MOD_ID, "animations/transformers/g1_hook.animation.json");
    }
